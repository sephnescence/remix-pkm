...
// BTTODO - This should probably be in PkmStoreyRepository
...
// BTTODO - Shouldn't this be in PkmStoreyRepository?
...
export const getSuiteItemCounts = async (userId: string) => {
  // SQL injection should be impossible here
